...
| M2 | Field 对局场地 | 水果实体的生成与销毁、2D 物理堆叠与合成解析、越线物理查询、道具对场地的直接作用（炸弹/锤子/**清屏**/摇一摇） | 计分与连击、状态机、广告与库存、HUD | `02-field.md` | `02-field-test.md` |
...
| 物理/堆叠/碰撞/合成/穿隧/抖动/CCD/限速/睡眠/警戒线检测/炸弹/锤子/清屏/摇一摇/水果生成 | M2 | `Docs/architecture/02-field.md` |
